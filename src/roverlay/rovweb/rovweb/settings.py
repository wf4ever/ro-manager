...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT, '../db') + '/admin.db', # Path to database file if using sqlite3.
...
SECRET_KEY = 'r(kw(q-hmpc=1)$ba43o)4kqicg$!xsb*y-fasz0o%14ic@2ii'
...
ROOT_URLCONF = 'rovweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rovweb.wsgi.application'
